...
#     print(f'{newID[i]},{newFirstName[i]},{newLastName[i]},{newDOB[i]},{newSSN[i]},{newState[i]}')
...
with open(output_file, 'w', newline="") as csvfile:
    ...
    for i in range(0,len(newID)):
        ...
        # csvwriter.writerow(f'{newID[i]},{newFirstName[i]},{newLastName[i]},{newDOB[i]},{newSSN[i]},{newState[i]}')